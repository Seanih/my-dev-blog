...
function PostPreview({ post }) {
	...
	return (
		<div className='flex items-center w-[82%] sm:w-[90%] max-w-[900px] py-8 mx-auto  border border-slate-700 rounded-xl my-4 sm:hover:scale-105 hover:shadow-xl duration-300 group'>
